...
public class KataPrimeFactors {
	...
	private List<Integer> findPrimes(int num) { 
		List<Integer> factors = new ArrayList<>();  // start with empty list 
		for(int potentialPrime = num / 2; potentialPrime > 1; potentialPrime-- ) {  //count potential prime down
