...
insert into products (product, price, description, category_id, image) values ('Radish', '1.42', 'A really tasty Radish - Pickled perfect for a picnic.', 3, 'https://www.wpclipart.com/food/vegetables/radish/radish.pngf');
